...
?>
  ...
  <?php
if ($slider=="reparacion"){
	echo "<h1>Reparaciones / Agenda / <script id'hora' type='text/javascript'>inicio()</script></h1>";
	};
if ($slider=="oscar"){
	echo "<h1 align='center'>Oscar / Agenda / <script id'hora' type='text/javascript'>inicio()</script></h1>";
	};
if ($slider=="feoli"){
	echo "<h1 align='center'>Feoli / Agenda / <script id'hora' type='text/javascript'>inicio()</script></h1>";
	};
if ($slider=="confeccion"){
	echo "<h1 align='center'>Confección / Agenda / <script id'hora' type='text/javascript'>inicio()</script></h1>";
	};
if ($slider=="alquiler"){
	echo "<h1 align='center'>Alquiler / Agenda / <script id'hora' type='text/javascript'>inicio()</script></h1>";
	};
?>
...
";
		while($fila=mysqli_fetch_array($cs)){
			...
			<td>";
			if($estado==" Listo"){
				echo"<a href='btn_estado.php?id=".$fila['id_reparacion']."&pagina=agenda&slider=".$slider."' target='_self' title='Listo'><img src='imagenes/listo.png' alt='img'; width='30' height='30' />$estado</a>";
				}
			if($estado==" Reparar"){
				echo"<a href='btn_estado.php?id=".$fila['id_reparacion']."&pagina=agenda&slider=".$slider."' target='_self' title='Reparar'><img src='imagenes/reparar.png' alt='img'; width='30' height='30' />$estado</a>";
				}
			if($estado==" Reparando"){
				echo"<a href='btn_estado.php?id=".$fila['id_reparacion']."&pagina=agenda&slider=".$slider."' target='_self' title='Reparando'><img src='imagenes/reparando.png' alt='img'; width='30' height='30' />$estado</a>";
				}
			if($estado==" Entregado"){
				echo"<a href='btn_estado.php?id=".$fila['id_reparacion']."&pagina=agenda&slider=".$slider."' target='_self' title='Entregado'><img src='imagenes/entregado.png' alt='img'; width='30' height='30' />$estado</a>";
				}
			echo"</td>
			<td>
            ...
            <td><a href='editar_cliente.php?id=".$fila['id_cliente']."&slider=".$slider."&pagina=agenda' title='Editar Cliente'>$nombre   $apellido</a></td>
            <td>$celular</td>
			...
			<td>
			<a href='prenda.php?id=".$fila['id_reparacion']."&slider=".$slider."&pagina=agenda' target='_self' title='Ver reparación'><img src='imagenes/ver.png' width='30' height='30' /></a>
			<a href='editar.php?id=".$fila['id_reparacion']."&slider=".$slider."&pagina=agenda' target='_self' title='Editar'><img src='imagenes/editar.png' width='30' height='30' /></a>
			<a href='dymo.php?cod_reparacion=".$fila['cod_reparacion']."&slider=".$slider."&pagina=agenda' target='_blank' title='Imprimir etiqueta DYMO'><img src='imagenes/print.png' width='30' height='30' /></a>
			</td>
            </tr>
			";
}
...
<button class='btn' type='submit' id='eliminar' name='oscar' onclick = 'this.form.action = \"eliminar.php?slider=".$slider."\"' title='Eliminar'><img src='imagenes/eliminar.png' alt='img'; width='30' height='30'> Eliminar</button>
</div></form></div></body>";
}
...
if ($slider=="feoli"){
	...
	$phphora="";
	$phphora2="";
	$sql="SELECT * FROM feoli INNER JOIN clientes ON feoli.id_cliente=clientes.id_cliente WHERE estado LIKE ' Reparar' OR estado LIKE ' Reparando' ORDER BY entrega ASC, hora ASC";
	$cs=mysqli_query($cn,$sql);
	echo"
<body>
<div class='demo_jui'>
...
";
		while($fila=mysqli_fetch_array($cs)){
			...
			<td>";
			if($estado==" Listo"){
				echo"<a href='btn_estado.php?id=".$fila['id_feoli']."&pagina=agenda&slider=".$slider."' target='_self' title='Listo'><img src='imagenes/listo.png' alt='img'; width='30' height='30' />$estado</a>";
				}
			if($estado==" Reparar"){
				echo"<a href='btn_estado.php?id=".$fila['id_feoli']."&pagina=agenda&slider=".$slider."' target='_self' title='Reparar'><img src='imagenes/reparar.png' alt='img'; width='30' height='30' />$estado</a>";
				}
			if($estado==" Reparando"){
				echo"<a href='btn_estado.php?id=".$fila['id_feoli']."&pagina=agenda&slider=".$slider."' target='_self' title='Reparando'><img src='imagenes/reparando.png' alt='img'; width='30' height='30' />$estado</a>";
				}
			if($estado==" Entregado"){
				echo"<a href='btn_estado.php?id=".$fila['id_feoli']."&pagina=agenda&slider=".$slider."' target='_self' title='Entregado'><img src='imagenes/entregado.png' alt='img'; width='30' height='30' />$estado</a>";
				}
			echo"</td>
			<td>
			<input name='data[]' type='checkbox' style='width:30px;height:30px;vertical-align: middle; cursor:pointer' id='data' value='$id'> $cod</input></td>
            <td><a href='editar_cliente.php?id=".$fila['id_cliente']."&slider=".$slider."&pagina=agenda' title='Editar Cliente'>$nombre   $apellido</a></td>
            <td>$celular</td>
			<td>$reparacion</td>
            <td>$phpdate2   $entrega</td>
			...
			<td>
			<a href='prenda.php?id=".$fila['id_feoli']."&slider=".$slider."&pagina=agenda' target='_self' title='Ver reparación'><img src='imagenes/ver.png' width='30' height='30' /></a>
			<a href='editar.php?id=".$fila['id_feoli']."&slider=".$slider."&pagina=agenda' target='_self' title='Editar'><img src='imagenes/editar.png' width='30' height='30' /></a>
			<a href='dymo.php?cod=".$fila['cod_feoli']."&slider=".$slider."&pagina=agenda' target='_blank' title='Imprimir etiqueta DYMO'><img src='imagenes/print.png' width='30' height='30' /></a>
			</td>
            </tr>
			";
}
