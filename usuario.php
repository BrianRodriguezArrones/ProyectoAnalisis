...
?>
  ...
  <h1 align="center">Usuario <?php echo $_SESSION['name']; ?></h1>
              ...
              <section>
                <div class="row">
                  <form id="formChat" role="form">
                    ...
                    <button id="send" class="btn btn-block bt-login1" data-loading-text="Procesando...">Enviar</button>
                  </form>
                </div>
              </section>
            </div>
...
<div class="fluid informacion2 "><!-- InstanceBeginEditable name="informacion2" -->
  <div class="login-form">
    <div class="form-header"> <i class="fa fa-users"></i> </div>
    <div class="form-register">
      <button class="btn btn-block bt-login" data-loading-text="Procesando...." onclick="window.location.href = 'clientes.php?slider=<?php echo"$slider"; ?>'">Consultar clientes</button>
    </div>
  </div>
  <!-- InstanceEndEditable --></div>
<div class="fluid informacion3 zeroMargin_desktop"><!-- InstanceBeginEditable name="informacion3" -->
  <div class="login-form">
    <div class="form-header"> <i class="fa fa-key"></i> </div>
    <div class="form-register">
      <button class="btn btn-block bt-login1" data-loading-text="Procesando...." onclick="window.location.href = 'cambio_contrasena.php?slider=<?php echo"$slider"; ?>'">Cambiar contraseña</button>
    </div>
  </div>
  <!-- InstanceEndEditable --></div>
<div class="fluid informacion4 "><!-- InstanceBeginEditable name="informacion4" -->
  <div class="login-form">
    <div class="form-header"> <i class="fa fa-users"></i> </div>
    <div class="form-register">
      <button class="btn btn-block bt-login1" data-loading-text="Procesando...." onclick="window.location.href = 'usuarios.php?slider=<?php echo"$slider"; ?>'">Consultar Usuarios</button>
    </div>
  </div>
  <!-- InstanceEndEditable --></div>
<div class="fluid informacion5 zeroMargin_desktop"><!-- InstanceBeginEditable name="informacion5" -->
  <div class="login-form">
    <div class="form-header"> <i class="fa fa-file-pdf-o"></i> </div>
    <div class="form-register">
      <button class="btn btn-block bt-login2" onclick="myFunction()">Generar informe PDF</button>
      <script>
function myFunction() {
...
<div class="fluid informacion6 "><!-- InstanceBeginEditable name="informacion6" -->
  <div class="login-form">
    <div class="form-header"> <i class="fa fa-power-off"></i> </div>
    <div class="form-register">
      <button class="btn btn-block bt-login2" data-loading-text="Procesando...." onclick="window.location.href = 'salir.php'">Cerrar sesión</button>
    </div>
  </div>
  <!-- InstanceEndEditable --></div>
