...
<button class="btn btn-block bt-login" data-loading-text="Procesando...." onclick="window.location.href = 'etiqueta.php'">Crear etiqueta</button>
</div>
</div> 
  <!-- InstanceEndEditable --></div>
...
<div class="form-register">
<button class="btn btn-block bt-login" data-loading-text="Procesando...." onclick="window.location.href = 'recibo.php'">Crear recibo</button>
</div>
</div> 
<!-- InstanceEndEditable --></div>
