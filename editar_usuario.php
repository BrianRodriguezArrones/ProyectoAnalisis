...
if(isset($_POST["actualizar"])){
    ...
    $foto=$_POST["foto"];
    $creado=$_POST["creado"];
    $sql="UPDATE users SET name='$nombre',email='$correo',social_id='$social_id',foto='$foto' WHERE user_id='$social_id'";
    mysqli_query($cn,$sql);
    echo "<script>
...
<input class='form-control' name='nombre' type='text' id='nombre' value='$nombre'></input>
...
<div align='center'>SOCIAL ID
<input class='form-control' name='social_id' type='text' id='social_id' value='$social_id' placeholder='Social Id'></input>
<span class='help-block'></span> 
</div>
<div align='center'>FOTO
<input type='file' id='foto' name='foto' class='form-control' onchange='handleFiles()' placeholder='Foto'></input>
<span class='help-block'></span> 
</div>
<div align='center'>CREADO
<input class='form-control' name='creado' type='text' id='creado' value='$creado' placeholder='Creado' readonly></input>
<span class='help-block'></span> 
</div>
