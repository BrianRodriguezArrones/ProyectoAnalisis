...
?>
  ...
  <div class="fluid informacion " align="center"><!-- InstanceBeginEditable name="informacion0" --> <!-- InstanceEndEditable --></div>
...
echo "
    <div class='login-form'>
      ...
      <div method='post' class='form-register'>
        ...
        <div>
          <div align='center'>
            <h3><b style='color:#1691BE'>Codigo:</b> $cod_cliente</h3>
          </div>
        </div>
        <div>
          <div align='center'>
            <h3><b style='color:#1691BE'>Nombre:</b> $nombre $apellido<h3>
          </div>
        </div>
        <div>
          <div align='center'>
            <h3><b style='color:#1691BE'>Celular:</b> $celular</h3>
          </div>
        </div>
        <div>
          <div align='center'>
            <h3><b style='color:#1691BE'>Telefono:</b> $telefono</h3>
          </div>
        </div>
		<div>
          <div align='center'>
            <h3><b style='color:#1691BE'>Correo:</b> $correo<h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class='login-form'>
      ...
      <div method='post' class='form-register'>
        ...
        <div>
          <div align='center'>
            <h3><b style='color:#1691BE'>Codigo:</b> $cod_reparacion</h3>
          </div>
        </div>
        <div>
          <div align='center'>
            <h3><b style='color:#1691BE'>Estado:</b> $estado</h3>
          </div>
        </div>
        <div>
          <div align='center'>
        ...
        <div>
          <div align='center'>
            <h3><b style='color:#1691BE'>Entregar:</b> $entrega</h3>
          </div>
        </div>
        <div>
          <div align='center'>
            <h3><b style='color:#1691BE'>Hora:</b> $hora</h3>
          </div>
        </div>
      </div>
    </div>
    ...
    ?>
  <!-- InstanceEndEditable --></div>
  <div class="fluid informacion3 zeroMargin_desktop"><!-- InstanceBeginEditable name="informacion3" -->
  <?php
  echo "
    <div class='login-form'>
      <div class='form-header'> <i class='fa fa-money'></i> </div>
      <div method='post' class='form-register'>
        <div>
          <div align='center'>
            <h2>Recibo</h2>
    ...
    ?>
  <!-- InstanceEndEditable --></div>
  <div class="fluid informacion4 "><!-- InstanceBeginEditable name="informacion4" -->
  <?php
  echo "
     <div class='login-form'>
      <div class='form-header'> <i class='fa fa-thumbs-up'></i> </div>
      <div method='post' class='form-register'>
        <div>
          <div align='center'>
            <h2>General</h2>
        ...
        <div>
          <div align='center'>
            <h3><b style='color:#1691BE'>Entro:</b> $entro a las $entroh</h3>
          </div>
        </div>
        <div>
          <div align='center'>
    ...
    ?>
  <!-- InstanceEndEditable --></div>
  <div class="fluid informacion5 zeroMargin_desktop"><!-- InstanceBeginEditable name="informacion5" -->
  <?php
  echo"
  <div class='login-form' align='center'>
    <div class='form-header'> <i class='fa fa-qrcode'></i> </div>
    <script type='text/javascript' src='js/qrcode.js'></script>
    <body onload='update_qrcode()'>
    <form method='post' class='form-register' style='height:490px'>
    ";
	  $id = base64_encode($id);//codifico la cadena
      echo "
      <input type='hidden' name='msg' value='trajeseventuales.com/qr.php?id=$id' />
      <div id='qr' style='margin-top:70px'></div>
    </form>
  </div>
  ";
  ?>
  <!-- InstanceEndEditable --></div>
  <div class="fluid informacion6 "><!-- InstanceBeginEditable name="informacion6" -->
  <?php
  echo"
  <div class='login-form' align='center'>
    <div class='form-header'> <i class='fa fa-camera'></i> </div>
    <div class='form-register'> <img src='$foto' alt='' /> </div>
  </div>
  ";
  ?>
  <!-- InstanceEndEditable --></div>
