...
$entrega="";
	...
	$sql="SELECT * FROM reparacion INNER JOIN clientes ON reparacion.id_cliente=clientes.id_cliente WHERE cod_reparacion='$cod_reparacion'";
		...
		while($fila=mysqli_fetch_array($cs)){
			...
			$fecha = strtotime( $fila["entrega"] );
			$entrega = date( 'd-m-Y', $fecha );
			$dia = strftime("%A ",$fecha);
			$hora1 = strtotime($fila["hora"]);
			$hora = strftime("%I:%M %p",$hora1);
			$fecha1 = strtotime( $fila["entrega"] );
...
<div id="etiqueta">
  <table width="319" border="0">
    <tbody>
      <tr>
        <td colspan="2"><b><font size="1">Nombre: </font></b><font size="1"><?php echo $nombre?> <?php echo $apellido?></font></td>
        <td width="95"><b><font size="1">Entro: </font></b><font size="1"><?php echo $fecha?></font></td>
        </tr>
      <tr>
        <td width="125"><b><font size="1" color="red">Codigo: </font></b><font size="1"><?php echo $cod_reparacion?></font></td>
        <td colspan="2"><b><font size="1">Celular: </font></b><font size="1"><?php echo $celular?></td>
        </tr>
      <tr>
        <td colspan="3"><b><font size="1">Detalle: </font></b><font size="1"><?php echo $reparacion?></font></td>
        </tr>
      <tr>
        <td><b><font size="1">Total: </font></b><font size="1">¢<?php echo $precio?></font></td>
        <td><b><font size="1">Abono: </font></b><font size="1">¢<?php echo $abono?></font></td>
        <td><b><font size="1" color="green">Saldo: </font></b><font size="1">¢<?php echo $saldo?></font></td>
        </tr>
      <tr>
        <td colspan="2"><b><font size="1" color="red">Entrega: </font></b><font size="1"><?php echo $dia?><?php echo $entrega?></font></td>
        <td colspan="3"><b><font size="1">Hora: </font></b><font size="1"><?php echo $hora?></font></td>
        </tr>
      </tbody>
  </table>
</div>
<button class="btn btn-block bt-login" type="button" onClick="javascript:imprSelec('etiqueta')" data-loading-text="Imprimiendo....">Imprimir</button>
      </form>
</div>
</div>
  <!-- InstanceEndEditable --></div>
