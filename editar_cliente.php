...
if(isset($_POST["actualizar"])){
    ...
    $correo=$_POST["correo"];
    $sql="UPDATE clientes SET nombre='$nombre',apellido='$apellido',celular='$celular',telefono='$telefono',correo='$correo' WHERE cod_cliente='$cod_cliente'";
    mysqli_query($cn,$sql);
    echo "<script>
...
<div class='form-header'> <i class='fa fa-edit'></i><i class='fa fa-user'></i> </div>
<form method='post' role='form' id='registrar-cliente' enctype='multipart/form-data' name='fe'>
<div class='form-register'>
<input type='hidden' id='id_cliente' name='id_cliente' value='$id_cliente'></input>
<div align='center'>CODIGO CLIENTE
<input class='form-control' name='cod_cliente' type='text' id='cod_cliente' value='$cod_cliente' readonly></input>
<span class='help-block'></span> 
</div>
<div align='center'>NOMBRE
<input class='form-control' name='nombre' type='text' id='nombre' value='$nombre' placeholder='Nombre'></input>
<span class='help-block'></span> 
</div>
<div align='center'>APELLIDOS
<input class='form-control' name='apellido' type='text' id='apellido' value='$apellido' placeholder='Apellido'></input>
<span class='help-block'></span> 
</div>
<div align='center'>CELULAR
<input class='form-control' name='celular' type='tel' id='celular' pattern='[0-9]{8}' value='$celular' placeholder='Celular'></input>
<span class='help-block'></span> 
</div>
<div align='center'>TELEFONO
<input class='form-control' name='telefono' type='tel' id='telefono' pattern='[0-9]{8}' value='$telefono' placeholder='Telefono'></input>
<span class='help-block'></span> 
</div>
<div align='center'>CORREO
<input class='form-control' name='correo' type='text' id='correo' value='$correo' placeholder='Correo'></input>
<span class='help-block'></span> 
</div>
<div align='center'>HABILITAR / DESABILITAR
<br></br>
<table width='200' border='0'>
  <tbody>
    <tr>
      <td><input type='radio' name='radio' value=' Reparar' style='width:35px;height:35px;vertical-align: middle; cursor:pointer' checked></td>
      <td><img src='imagenes/habilitado.png' alt='img'; width='40' height='40'></td>
      <td><input type='radio' name='radio' value=' Reparar' style='width:35px;height:35px;vertical-align: middle; cursor:pointer' checked></td>
      <td><img src='imagenes/desabilitado.png' alt='img'; width='40' height='40'></td>
    </tr>
  </tbody>
</table>
...
<br></br>
<button class='btn btn-block bt-login1' type='submit' name='actualizar' id='submit_btn' data-loading-text='Actualizando....' >Actualizar</button>
</form>
</div>
</div>
";
