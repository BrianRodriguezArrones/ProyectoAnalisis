...
<script type="text/javascript">
  ...
  <link rel="stylesheet" href="css/estilotablas.css">
	...
	(min-device-width: 768px) and (max-device-width: 1024px)  {
		...
		td:nth-of-type(4):before { content: "Social Id:"; }
		td:nth-of-type(5):before { content: "Foto:"; }
		td:nth-of-type(6):before { content: "Creado:"; }
		td:nth-of-type(7):before { content: "Mantenimiento:"; }
	}
	@media only screen
...
";
		while($fila=mysqli_fetch_array($cs)){
			...
			echo "
			<tr> 
            <td><a href='editar_usuario.php?id=".$fila['user_id']."&slider=".$slider."&pagina=usuarios' title='Editar Contraseña'>$user_id</a></td>
            <td><a href='editar_usuario.php?id=".$fila['user_id']."&slider=".$slider."&pagina=usuarios' title='Editar Contraseña'>$nombre</a></td>
			<td><a href='editar_usuario.php?id=".$fila['user_id']."&slider=".$slider."&pagina=usuarios' title='Editar Contraseña'>$correo</a></td>
			<td><a href='editar_usuario.php?id=".$fila['user_id']."&slider=".$slider."&pagina=usuarios' title='Editar Contraseña'>$social_id</a></td>
			<td><a href='editar_usuario.php?id=".$fila['user_id']."&slider=".$slider."&pagina=usuarios' title='Editar Contraseña'>$foto</a></td>
			<td>$creado</td>
			<td>
			<a href='editar_usuario.php?id=".$fila['user_id']."&slider=".$slider."&pagina=usuarios' target='_self' title='Editar Usuario'><img src='imagenes/editar.png' width='30' height='30' /></a>
			<a href='editar_usuario.php?id=".$fila['user_id']."&slider=".$slider."&pagina=usuarios' target='_self' title='Desabilitar'><img src='imagenes/habilitado.png' width='30' height='30' /></a>
			</td>
            </tr>
			";
}
