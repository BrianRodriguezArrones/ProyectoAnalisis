				...
				<div class="row">
					<form id="formChat" role="form">
						<div class="form-group">
							<label for="user"><h3>Usuario</h3></label>
							<input type="text" value="<?php echo $_SESSION['name']; ?>" class="form-control" id="user" name="user" required>
						</div>
						<div class="form-group">							
							<div class="row">
								<div class="col-md-12" >
									<div id="conversation" style="height:200px; border: 1px solid #CCCCCC; padding: 12px;  border-radius: 5px; overflow-x: hidden; text-align:left; color:#000000">	
									</div>
								</div>
							</div>
						</div>
						<div class="form-group">				
							<label for="message"><h3>Mensaje</h3></label>
