...
<?php
if ($slider=="reparacion"){
	echo "<h1 align='center'>Reparaciones / Buscar</h1>";
	};
if ($slider=="oscar"){
	echo "<h1 align='center'>Oscar / Buscar</h1>";
	};
if ($slider=="feoli"){
	echo "<h1 align='center'>Feoli / Buscar</h1>";
	};
if ($slider=="confeccion"){
	echo "<h1 align='center'>Confección / Buscar</h1>";
	};
if ($slider=="alquiler"){
	echo "<h1 align='center'>Alquiler / Buscar</h1>";
	};
?> 
...
<select>
  ...
  <option value='Todos'>Todos</option>
	...
	";
	if ($slider=="reparacion"){
	$sql="SELECT * FROM reparacion INNER JOIN clientes ON reparacion.id_cliente = clientes.id_cliente WHERE YEAR(reparacion.entro) = '".$fecha."' ";
...
";
		while($fila=mysqli_fetch_array($cs)){
			...
			<td>";
			if($estado==" Listo"){
				echo"<a href='btn_estado.php?id=".$fila['id_reparacion']." & pagina=buscar&slider=".$slider."' target='_self' title='Listo'><img src='imagenes/listo.png' alt='img'; width='30' height='30' />$estado</a>";
				}
			if($estado==" Reparar"){
				echo"<a href='btn_estado.php?id=".$fila['id_reparacion']." & pagina=buscar&slider=".$slider."' target='_self' title='Reparar'><img src='imagenes/reparar.png' alt='img'; width='30' height='30' />$estado</a>";
				}
			if($estado==" Reparando"){
				echo"<a href='btn_estado.php?id=".$fila['id_reparacion']." & pagina=buscar&slider=".$slider."' target='_self' title='Reparando'><img src='imagenes/reparando.png' alt='img'; width='30' height='30' />$estado</a>";
				}
			if($estado==" Entregado"){
				echo"<a href='btn_estado.php?id=".$fila['id_reparacion']." & pagina=buscar&slider=".$slider."' target='_self' title='Entregado'><img src='imagenes/entregado.png' alt='img'; width='30' height='30' />$estado</a>";
				}
			echo"</td>
            ...
            <td><a href='editar_cliente.php?id=".$fila['id_cliente']."&slider=".$slider."&pagina=buscar' title='Editar Cliente'>$nombre   $apellido</a></td>
            <td><a href='editar_cliente.php?id=".$fila['id_cliente']."&slider=".$slider."&pagina=buscar' title='Editar Cliente'>$celular</a></td>
			...
			<td>
			<a href='prenda.php?id=".$fila['id_reparacion']."&slider=".$slider."&pagina=buscar' target='_self' title='Ver reparación'><img src='imagenes/ver.png' width='30' height='30' /></a>
			<a href='editar.php?id=".$fila['id_reparacion']."&slider=".$slider."&pagina=buscar' target='_self' title='Editar reparación'><img src='imagenes/editar.png' width='30' height='30' /></a>
			<a href='dymo.php?cod_reparacion=".$fila['cod_reparacion']."&slider=".$slider."&pagina=buscar' target='_blank' title='Imprimir etiqueta DYMO'><img src='imagenes/print.png' width='30' height='30' /></a>
			</td>
            </tr>
			";
}
echo "</tbody></table>
<div class='botonera'>
<input name='pagina' type='hidden' id='pagina' value='buscar'></input>
...
<button class='btn' type='submit' id='reparacion' name='reparacion' onclick = 'this.form.action = \"estado.php?slider=".$slider."\"' title='Estado'><img src='imagenes/estado.png' alt='img'; width='30' height='30'> Estado</button>
...
if ($slider=="feoli"){
	$sql="select * from feoli INNER JOIN clientes ON feoli.id_cliente = clientes.id_cliente";
	$cs=mysqli_query($cn,$sql);
	echo"
<body>
<div class='demo_jui'>
...
";
		while($fila=mysqli_fetch_array($cs)){
			...
			<td>";
			if($estado==" Listo"){
				echo"<a href='btn_estado.php?id=".$fila['id_feoli']." & pagina=buscar&slider=".$slider."' target='_self' title='Listo'><img src='imagenes/listo.png' alt='img'; width='30' height='30' />$estado</a>";
				}
			if($estado==" Reparar"){
				echo"<a href='btn_estado.php?id=".$fila['id_feoli']." & pagina=buscar&slider=".$slider."' target='_self' title='Reparar'><img src='imagenes/reparar.png' alt='img'; width='30' height='30' />$estado</a>";
				}
			if($estado==" Reparando"){
				echo"<a href='btn_estado.php?id=".$fila['id_feoli']." & pagina=buscar&slider=".$slider."' target='_self' title='Reparando'><img src='imagenes/reparando.png' alt='img'; width='30' height='30' />$estado</a>";
				}
			if($estado==" Entregado"){
				echo"<a href='btn_estado.php?id=".$fila['id_feoli']." & pagina=buscar&slider=".$slider."' target='_self' title='Entregado'><img src='imagenes/entregado.png' alt='img'; width='30' height='30' />$estado</a>";
				}
			echo"</td>
            ...
            <td>$phphora2</td>
			<td>
			<a href='prenda.php?id=".$fila['id_feoli']."&slider=".$slider."&pagina=buscar' target='_self' title='Ver reparación'><img src='imagenes/ver.png' width='30' height='30' /></a>
			<a href='editar.php?id=".$fila['id_feoli']."&slider=".$slider."&pagina=buscar' target='_self' title='Editar reparación'><img src='imagenes/editar.png' width='30' height='30' /></a>
			<a href='dymo.php?cod_feoli=".$fila['cod_feoli']."&slider=".$slider."&pagina=buscar' target='_blank' title='Imprimir etiqueta DYMO'><img src='imagenes/print.png' width='30' height='30' /></a>
			</td>
            </tr>
			";
}
